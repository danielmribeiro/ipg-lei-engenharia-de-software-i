# Engenharia de Software I (Software Engineering I)
...
3. Model systems using entity-relationship models and apply normalization. Design data models for database implementation.
4. Recognize basic principles of project planning and management. Be able to analyze a system and develop the corresponding planning (resources and costs involved).
